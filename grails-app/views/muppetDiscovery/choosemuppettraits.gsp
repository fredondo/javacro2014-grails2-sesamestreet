...
<title><g:message code="muppet.title" default=".:Muppet Discovery:." /></title>
</head>
<body>
	<div class="content">
		...
		<g:form action="search">
			<div class="fieldcontain ${hasErrors(bean:desiredTraits,field:'color','errors')}">	
				...
				<g:select name="color" from="${['red', 'orange', 'yellow', 'blue', 'green', 'purple']}" 
					value="${desiredTraits?.color}" noSelection="['':'-Choose color-']"/>
			</div>
